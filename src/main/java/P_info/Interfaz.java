...
public class Interfaz {
    ...
    private void opcion1() {
        ...
        int contador = 0;
        List<Usuario> usuarios1 = usuarios.subList(0, usuarios.size());
        for (Usuario us : usuarios1) {
            if (us != null && us.getNombre().equals(CUsuario) && us.getContrasenia().equals(contra)) {
                contador++;
        ...
        if(contador!=1)System.out.println("Usuario no existente");
